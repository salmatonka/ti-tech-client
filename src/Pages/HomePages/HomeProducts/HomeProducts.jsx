...
const HomeProducts = () => {
  ...
  return (
    <div className='py-10'>
      <div>
        <h2 className="text-2xl font-semibold tracking-wide flex justify-center pb-10">Monitor</h2>
      ...
      <div className='py-16'>
        <h2 className="text-2xl font-semibold tracking-wide flex justify-center pb-10">Processor</h2>
        <div className='grid lg:grid-cols-5 md:grid-cols-2 sm:grid-cols-1 gap-6'>
          {
      ...
      <div>
         <h2 className="text-2xl font-semibold tracking-wide flex justify-center pb-10">Motherboard</h2>
           <div className='grid lg:grid-cols-5 md:grid-cols-2 sm:grid-cols-1 gap-6'>
          {
