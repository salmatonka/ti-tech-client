...
import { MdDarkMode, MdLightMode, MdLogout, MdOutlineDashboard } from 'react-icons/md';
...
const DashboardNav = ({ setDarkMode, darkMode }) => {
    ...
    return (
        ...
        <div className='dark:bg-[#0F172A] dark:text-white  bg-white shadow-md'>
            {/* nav-left-right-side */}
        ...
        //    <div className="navbar py-2 dark:bg-[#120505] dark:text-white bg-white text-gray-600 shadow-md">
