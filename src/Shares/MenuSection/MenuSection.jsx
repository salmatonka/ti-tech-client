...
const MenuSection = () => {
  ...
  // console.log(brands)
  return (
   <div className='lg:flex hidden z-50 bg-[#1F294E] '>
        ...
        <ul>
          <li>Desktop
            <div className='menu-dropdown'>
              <ul>
                <li><a className='flex justify-between items-center' href="">AMD Destop PC</a></li>
                <li><a className='flex justify-between items-center' href="">Intel Destop PC</a></li>
              </ul>
            </div>
          </li>
